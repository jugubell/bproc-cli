public class Log {
    ...
    public static void help() {
        System.out.println("*** Help for BProC ***");
        System.out.println();
        System.out.println("Description:");
        System.out.println("    BProC is a simple compiler for compiler assembler files '.bpasm'");
        System.out.println("    for basic processor intended for education use. ");
        System.out.println();
        System.out.println("Usage:");
        System.out.println("    java -jar bproc.jar [-action <inputFile (*.bpasm)>] [optional -o <outputFileName/outputDirectory>] [optional <compileType (bin|hex|hexv3)>]");
        System.out.println();
